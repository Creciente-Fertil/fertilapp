<script>
    ...
    import { changePassword, forgotPassword } from "$lib/java/usuarios/usuariosback";
    ...
    async function resetPB(params) {
        ...
        try {
            ...
            Swal.fire(
                "Correo denegado",
                "No se pudo enviar el correo con las instrucciones",
                "error",
            );
        }
    }
    ...
    async function reset() {
        if (versionjava) {
            ...
            try {
                await forgotPassword(usuariomail)
                Swal.fire(
                    "Correo enviado",
                    "Se envió un correo con las instrucciones",
                    "success",
