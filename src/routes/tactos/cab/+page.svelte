<script>
    ...
    import Buscador from "$lib/components/tactos/Buscador.svelte";
    ...
    function ordenarTactosDescendiente(p_forma) {
        ...
        if (forma == "fecha") {
            ...
            tactosrow.sort(
                (a1, a2) => escalar * (a1.prenada < a2.prenada ? -1 : 1),
            );
        } else if (forma == "tipo") {
            tactosrow.sort(
                (a1, a2) => escalar * a1.tipo.localeCompare(a2.tipo),
            );
        }
    }
                    ...
                    <div class="form-control">
                        <label class="label cursor-pointer">
                            ...
                            <input
                                ...
                                onclick={() => ordenarTactos(selectforma)}
                            />
                        </label>
                    </div>
                </div>
            ...
            <form method="dialog">
                ...
                {:else}
                    ...
                    <button
                        ...
                        onclick={() => eliminar(idtacto)}>Eliminar</button
                    >
                {/if}
