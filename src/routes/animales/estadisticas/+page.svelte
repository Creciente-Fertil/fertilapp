<script>
    ...
    function calcularStockHistorial(movimientos){
        ...
        for(let i = 0;i<movimientos.length;i++){
            ...
            historicomap[movimiento.grupo].historial[fecha].peso += movimiento.peso
        }
        let grupos_cantidad = {}
    ...
    function procesarFilas() {
        ...
        for (let i = 0; i < historiarows.length; i++) {
            ...
            todos_movimientos_lote = todos_movimientos_lote.concat(movimientos.movimientos_lotes)
            todos_movimientos_rodeo = todos_movimientos_rodeo.concat(movimientos.movimientos_rodeos)
            todos_movimientos_categoria = todos_movimientos_categoria.concat(movimientos.movimientos_categorias)
        }
        ...
        categoriahistorico = calcularStockHistorial(todos_movimientos_categoria)
...
<Navbar2>
    ...
    <div class="grid grid-cols-3 mx-1 lg:mx-10 mt-1 w-11/12">
        <div class="">
            <h1 class="text-2xl">Estadisticas</h1>
        </div>
    ...
    >
        ...
        <input type="radio" name="lote_tabs" class="tab" aria-label="Rodeos" />
        <div
            class={`
                tab-content rounded-md p-2 space-y-4
                dark:bg-gray-900 bg-white
