<script>
    ...
    async function ingresarJava() {
        ...
        try {
            ...
            console.error(err);
            // Filtramos por la propiedad .code
            if (err.message === "credenciales") {
                Swal.fire("Error", "Credenciales incorrectas", "error");
            } else if (err.message === "eliminado") {
                Swal.fire(
                    "Atención",
    ...
    async function ingresar() {
        ...
        try {
                    ...
                    if (reccabs.totalItems > 0) {
                        ...
                        if (recordcolabcab.totalItems > 0) {
                            ...
                            const recordper = await pb
                                .collection("permisos")
                                .getFirstListItem(`estxcolab='${colabcab.id}'`);
            ...
            Swal.fire(
                "Error login",
                "No se puede logear, puede que esten mal escritas las credenciales",
                "error",
            );
        }
    }
            ...
            >
                <g id="Capa_x0020_1">
                    ...
                    <g id="_710282024">
                        ...
                        <path
                            class="fil0"
                            d="M18130.21 6965.5l0 1524.13c0,153.08 144.73,118.55 338.69,118.55 117.86,0 119.71,-97.17 118.94,-270.56l-0.39 -1219.7c215.6,-103.45 575.78,19.86 575.78,-118.55 0,-276.57 40.72,-338.69 -169.35,-338.69 -235.45,0 -863.67,-9.03 -863.67,304.82z"
                        />
                        <path
                            class="fil0"
                            d="M20839.78 6796.16l0 1659.6c0,61.4 14.22,94.53 33.87,135.48 119.17,27.77 270.32,27.77 389.5,0 19.65,-40.95 33.86,-74.08 33.86,-135.48l0 -1659.6c0,-157.57 -160.58,-135.48 -287.89,-135.48 -101,0 -169.34,34.54 -169.34,135.48z"
                        />
                        <path
                            class="fil0"
                            d="M21771.19 3476.94l0 1710.41c0,154.81 149.91,118.54 355.63,118.54 39.49,0 84.67,-45.18 84.67,-84.67l0 -1778.15c0,-97.84 -185.4,-84.68 -270.95,-84.68 -93.16,0 -169.35,22.43 -169.35,118.55z"
                        />
                        <path
                            class="fil0"
                            d="M17672.97 6508.26c92.95,62.25 97.83,118.55 237.09,118.55 48.98,0 443.33,-368.97 491.11,-440.31 -23.05,-98.93 -150.88,-203.21 -254.03,-203.21 -68.42,0 -294.11,304.43 -368.24,376.88 -70.39,68.78 -60.65,62.51 -105.93,148.09z"
                        />
                        <path
                            class="fil0"
                            d="M21923.6 3087.44c240.27,0 321.76,20.6 321.76,-254.02 0,-260.53 -129.43,-220.16 -355.63,-220.16 -135.6,0 -155.43,154.57 -150.32,251.66 7.22,137.11 30.13,222.52 184.19,222.52z"
                        />
                        <path
                            class="fil0"
                            d="M20822.84 6084.89c0,297.7 -2.07,304.83 304.83,304.83 204.42,0 186.28,-145.79 186.28,-287.89 0,-220.81 -148.37,-186.28 -321.76,-186.28 -121.06,0 -169.35,48.28 -169.35,169.34z"
                        />
                    </g>
                </g>
            </svg>
