        ...
        <thead class={`${estilos.tableheader}  sticky top-0 z-5 shadow-sm`}>
            <tr>
                ...
                <th
                    ...
                    `}
                >
                    <div class="flex flex-row justify-between">Caravana</div>
                </th>
                <th
                ...
                <th
                    ...
                    `}
                >
                    <div class="flex flex-row justify-between">Padre</div>
                </th>
        ...
        <tbody>
            {#each rows as n}
                <tr>
                    ...
                    <td class={`text-base ml-3 pl-3 mr-1 pr-1 ${pyfila}`}>{new Date(n.fecha).toLocaleDateString()}</td>
                    <td class={`text-base ml-3 pl-3 mr-1 pr-1 ${pyfila}`}>{`${shorterWord(n.caravana)}`}</td>
                    <td class={`text-base ml-3 pl-3 mr-1 pr-1 ${pyfila}`}>{`${shorterWord(n.nombremadre)}`}</td>
                    <td class={`text-base ml-3 pl-3 mr-1 pr-1 ${pyfila}`}>{`${shorterWord(n.nombrepadre)}`}</td>
