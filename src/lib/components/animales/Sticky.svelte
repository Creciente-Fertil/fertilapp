...
{#if isVisible}
    ...
    >
        ...
        >
            <!-- Izquierda: Texto -->
            <div class="text-sm sm:text-base text-gray-700 dark:text-gray-200 font-medium">
                <span class="hidden xl:block">{longdescripcion}: <strong>{total}</strong></span>
                <span class="xl:hidden">{shortdescripcion}: <strong>{total}</strong></span>
            </div>
